...
namespace Ftl.SalesCrm.Migrations
{
    ...
    [Migration("20230319181511_Created_Leadstatus_Entity")]
    partial class CreatedLeadstatusEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ftl.SalesCrm.Contacts.Contact", b =>
                {
                    ...
                    b.Property<DateTime?>("OwnerAssigneddate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Ftl.SalesCrm.LeadStatuses.LeadStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppLeadStatuses", (string)null);
                });

            modelBuilder.Entity("Ftl.SalesCrm.Lifecyclestages.Lifecyclestage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppLifecyclestages", (string)null);
                });
            ...
            modelBuilder.Entity("Ftl.SalesCrm.Contacts.Contact", b =>
                {
                    b.HasOne("Ftl.SalesCrm.LeadStatuses.LeadStatus", null)
                        .WithMany()
